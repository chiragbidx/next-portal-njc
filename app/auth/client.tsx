  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        ...
        description: "Start managing your contacts and deals",
        button: "Sign Up",
        helper: (
          <span>
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Organize your sales—together.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure CRM, collaborative dashboard, and a clean onboarding flow built for busy sales teams.
              </p>
            </div>
